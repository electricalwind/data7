...
public class CVEParser {
    ...
    /**
     * Method to parse the XML NVD file and return a list of all Vulnerability-CWE  for a given software that have a commit link
     */
    public static List<CVE> XMLparse(Project project, String filepath) throws FileNotFoundException, XMLStreamException, ParseException {
        ...
        while (eventReader.hasNext()) {
            ...
            if (xmlEvent.isStartElement()) {
                ...
                switch (startElement.getName().getLocalPart()) {
                    case "entry":
                        if (softstudy) {
                            currentCVE = new CVE(cve, score, summary, lastModified);
                    ...
                    case "references":
                        ...
                        if (idAttr != null) {
                            ...
                            if (m.find() && softstudy) {
                                commit.add(m.group(project.getIndexOfHashInRegexp()));
                            }
                            //bug
     ...
     */
    private static Matcher softwareMatch(String soft) {
     ...
     * @return Matcher
     */
    private static Matcher gitMatch(String url, Project pI) {
     ...
     * @return Matcher
     */
    private static Matcher btMatch(String url, Project pI) {
     ...
     */
    private static boolean functionSOft(XMLEvent xmlEvent) {
